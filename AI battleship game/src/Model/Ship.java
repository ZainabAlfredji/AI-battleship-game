...
public class Ship {
     ...
     *
     * @param gridPosition Model.Position where the ship is now on the grid.
     * @param drawPosition Model.Position to draw the Model.Ship at in Pixels.
     */
    ...
    /**
     * Prints out the kind of ship that gets destroyed*/
